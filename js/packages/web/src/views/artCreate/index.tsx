          ...
          {0 < step && step < 5 && (
            <div style={{margin: 'auto', width: 'fit-content'}}>
              <Button
                onClick={() =>
                  gotoStep(
                    step === 2 && attributes.isDynamicWeatherNFT
                      ? step - 2
                      : step - 1,
                  )
                }
          ...
          <Row>
            <Button
              ...
              onClick={() =>
                props.confirm({
                  category: MetadataCategory.Image,
                  isDynamicWeatherNFT: true,
                })
              }
            >
              <div>
                <div>Dynamic Weather NFT</div>
                <div className="type-btn-description">
                  Weather Can be evolved dynamically
                </div>
              </div>
            </Button>
          </Row>
  ...
  return (
    <>
      ...
      <Row className="content-action" justify="space-around">
        <Col>
          {(props.attributes.isDynamicWeatherNFT ||
            ...
            <ArtCard
              ...
              artView={
                !(
                  props.files.length >
                  1 + (props.attributes.isDynamicWeatherNFT ? 1 : 0)
                )
              }
