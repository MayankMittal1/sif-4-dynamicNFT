...
export const mintNFT = async (
  ...
  const additionalAttributes: Attribute[] = isDynamicWeatherNFT
    ? [
        {
          trait_type: 'isDynamicWeatherNFT',
          value: 'true',
          display_type: 'Is Dynamic Weather NFT?',
        },
        {
          trait_type: 'weatherIndex',
          value: '0',
          display_type: 'Weather Index',
        },
      ]
    : [];
...
export const changeWeatherNFT = async (
  connection: Connection,
  wallet: WalletSigner | undefined,
  endpoint: ENDPOINT_NAME,
  metadata: {
  ...
  const weatherIndex = attributes.findIndex(
    attr => attr.trait_type === 'weatherIndex',
  );
  if (weatherIndex && weatherIndex >= 0) {
    attributes.splice(weatherIndex, 1);
  }
